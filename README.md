...
Simply pass `channel=<your_channel>` (without `<` and `>`) to the URL, e.g. [`https://grasp.dialogik.tv?channel=dialogikTV`](https://grasp.dialogik.tv?channel=dialogikTV) and you're ready to go!
